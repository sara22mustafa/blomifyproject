    ...
    <div>
      ...
      <ul className="mt-12 space-y-8">
        ...
        <li className="flex items-center">
          ...
          <a href="tel:+201066787955" className="text-white text-sm ml-4">
            +20 0106677955
          </a>
        </li>
        <li className="flex items-center">
          ...
          <a href="f" className="text-white text-sm ml-4">
      ...
      <ul className="flex mt-12 space-x-4">
        {SocialICon.map((item, index) => (
          <div key={item.id}>
            <li className="bg-pale-grayish animate-pulse h-10 w-10 rounded-full flex items-center justify-center shrink-0">
              <a href={item.refrance} target="_blank" rel="noreferrer">
                {item.icon}
              </a>
            </li>
          </div>
